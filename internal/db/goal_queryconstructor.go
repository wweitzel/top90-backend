...
func countGoalsQuery(filter GetGoalsFilter) (string, []any) {
...
func getGoalsQuery(pagination Pagination, filter GetGoalsFilter) (string, []any) {
	filter.SearchTerm = "%" + filter.SearchTerm + "%"
...
func insertGoalQuery(goal *top90.Goal) string {
...
func updateGoalQuery(id string, goalUpdate top90.Goal) (string, []any) {
	var args []any
